...
def get_args():
    ...
    # Define agent_data_path with a default value (optional argument with --)
    parser.add_argument('--agent_data_path', type=str,
                        default=r'E:\ADT',  # Default path for agent data
                        help='Path to the aria sequences (default: E:\\ADT)')

    # Define output_path with a default value (optional argument with --)
    parser.add_argument('--output_path', type=str,
                        default=r'C:\Users\hthh1\Downloads\MA_ADT',  # Default output path
                        help='Output path to the resulting data (default: E:\\MA_ADT)')
